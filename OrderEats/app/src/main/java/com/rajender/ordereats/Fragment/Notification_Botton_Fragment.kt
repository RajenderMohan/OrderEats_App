...
import com.rajender.ordereats.adapter.NotificationAdapter
import com.rajender.ordereats.databinding.FragmentNotificationBottonBinding
...
class Notification_Botton_Fragment : BottomSheetDialogFragment() {
   private lateinit var binding : FragmentNotificationBottonBinding
    ...
    override fun onCreateView(
        ...
        val notificationImages = listOf(R.drawable.sademoji, R.drawable.driver_icon, R.drawable.congrats_icon)
